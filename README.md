...
## Зміст:
1. [Опис проєкту](#опис-проекту)
2. [Частина 2](#результати-тренування-простої-моделі)
3. [Частина 3](#результати-тренування-моделі-з-вручну-підібраними-параметрами)
4. [Частина 3 (авто)](#результати-тренування-моделі-з-автоматично-підібраними-параметрами)
5. [Частина 4](#результати-тренування-претренованих-моделей)
